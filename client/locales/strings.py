...
STRINGS = {
    "ru": {
        ...
        "smr_area": "Площадь, м²",
        "smr_total": "СМР",
        "smr_grand": "Оборудование + СМР",
        "pv_only_in_stock": "Только позиции в наличии",
        "pv_stock_empty": "С галочкой «Только позиции в наличии» не осталось ни одной позиции: точных совпадений и подтверждённых строк нет.",
        "pv_stock_dropped": "Не вошло в файл: {n} поз. (нет точного совпадения или подтверждения)",
    },
    ...
    "kz": {
        ...
        "smr_area": "Ауданы, м²",
        "smr_total": "ҚМЖ",
        "smr_grand": "Жабдық + ҚМЖ",
        "pv_only_in_stock": "Тек қолда бар позициялар",
        "pv_stock_empty": "«Тек қолда бар позициялар» белгісімен бірде-бір позиция қалмады: нақты сәйкестіктер де, расталған жолдар да жоқ.",
        "pv_stock_dropped": "Файлға енбеді: {n} поз. (нақты сәйкестік немесе растау жоқ)",
    },
}
